...
@WebService(endpointInterface = "trackit.webservices.ExpensesReportsService")
public class ExpensesReportsServiceImpl implements ExpensesReportsService {
	...
	public void setPayeeService(PayeeService service) {
		this.payeeService = service;
	}
