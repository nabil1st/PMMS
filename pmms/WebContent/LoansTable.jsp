...
value="#{loanSummaryBean.loans}" var="account" rowKeyVar="index">
    <f:facet name="header">
        <rich:columnGroup>                            
            <h:column>
    ...
    <h:column>
        ...
        actionListener="#{loanSummaryBean.loanHistoryAction}"
...
<rich:datascroller align="center" for="loanList" maxPages="20" 
	page="#{borrowerListBean.scrollerPage}" reRender="loan_sc1" id="loan_sc2" renderIfSinglePage="false"/>
</h:panelGrid>  