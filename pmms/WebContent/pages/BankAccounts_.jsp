        ...
        <body>            
            <h:form id="BankAccounts">                
                ...
                <h:panelGrid columns="3">
                    ...
                    <h:commandButton value="New Bank Account" action="#{bankAccountListBean.newAction}"/>
                </h:panelGrid>
                ...
                <rich:datascroller align="center" for="expensesList" maxPages="20" 
                	page="#{bankAccountListBean.scrollerPage}" reRender="sc1" id="sc2" renderIfSinglePage="false" />          
				</h:panelGrid>
