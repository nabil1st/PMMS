 ...
 * @author HP
 */
public class SelectBankAccountActivity extends Activity implements OnClickListener {
    ...
    protected int getViewId() {
        return R.layout.select_bank_account;
    }
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.ok) {
            ...
            data.putExtra("BankAccountName", selectedBankAccount.getDescription());
